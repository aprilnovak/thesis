...
\begin{figure}[h!]
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=1.1\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/pbfhr_core.png}
...
\centering
\hspace{1.1cm}
\includegraphics[width=0.5\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/center_reflector_labeled.png}
...
\centering
\hspace{1.5cm}
\includegraphics[width=0.6\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/pbfhr_pebble.png}
...
\centering
\hspace{1cm}
\includegraphics[width=0.5\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/pbfhr_slice.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/pbfhr_or.png}
...
\begin{figure}[h!]
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[width=0.6\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/pbfhr_or2.png}
       \caption{Volume rendering}
    \end{subfigure}
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[width=0.6\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/pbfhr_or1.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.4\linewidth]{../../pronghorn/doc/figures/pbfhr_pebble_mesh_cross_section.png}
...
\begin{subfigure}{.475\textwidth}
  \centering
  \includegraphics[height=5.3cm]{../../pronghorn/doc/papers/MC2019/figures/pbfhr_16_slice_pf20.png}
  \caption{Along plane parallel to \(x\) axis}
  \label{fig:octant1}
\end{subfigure}
\begin{subfigure}{.475\textwidth}
  \centering
  \includegraphics[height=5.3cm]{../../pronghorn/doc/papers/MC2019/figures/pbfhr_16_surfaces_pf20.png}
...
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../../pronghorn/doc/papers/MC2019/figures/hsd_hlm_0.pdf}
  \caption{Materials in particle}
  \label{fig:hsd1}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../../pronghorn/doc/papers/MC2019/figures/hsd_hlm_1.pdf}
...
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=0.85\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/vertical.png}
  \caption{Vertical flow geometry}
  \label{fig:vertical}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=0.85\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/horizontal.png}
...
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=0.8\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/Re500_cm05_U.png}
  \caption{\(Re=500\)}
\end{subfigure}
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=0.8\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/Re2000_cm05_U.png}
  \caption{\(Re=2000\)}
\end{subfigure}
...
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=0.8\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/Re500_cm1_U.png}
  \caption{\(Re=500\)}
\end{subfigure}
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=0.8\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/Re2000_cm1_U.png}
  \caption{\(Re=2000\)}
\end{subfigure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.375\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/heat_source.png}
...
\begin{subfigure}{.32\textwidth}
  \centering
  \includegraphics[height=1.5\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/bc_A.png}
  \caption{Condition A}
\end{subfigure}
\begin{subfigure}{.32\textwidth}
  \centering
  \includegraphics[height=1.5\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/bc_B.png}
  \caption{Condition B}
\end{subfigure}
\begin{subfigure}{.32\textwidth}
  \centering
  \includegraphics[height=1.5\linewidth]{../../pronghorn/doc/papers/PBFHR/figs/bc_C.png}
  \caption{Condition C}
\end{subfigure}

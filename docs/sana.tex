...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\linewidth]{../../pronghorn/doc/figures/sana_permutation.png}
...
\begin{figure}[h!]
\centering
\includegraphics[height=0.65\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/sana_30kW_vel.png}
...
\begin{figure}[h!]
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=0.75\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/exp_total_A.pdf}
       \caption{Case A: 5 \si{\kilo\watt} helium}
       \label{fig:helium_longa}
    \end{subfigure}
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=0.75\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/exp_total_F.pdf}
...
\begin{figure}[h!]
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=0.75\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/exp_total_G.pdf}
       \caption{Case C: 5 \si{\kilo\watt} nitrogen}
       \label{fig:nitrogen_longa}
    \end{subfigure}
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=0.75\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/exp_total_L.pdf}
...
\begin{figure}[h!]
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=0.75\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/exp_total_D2.pdf}
       \caption{Case E: 30 \si{\kilo\watt} helium}
    \end{subfigure}
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=0.75\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/exp_total_J2.pdf}
...
\begin{figure}[h!]
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=0.75\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/exp_total_U2.pdf}
       \caption{Case G: 20 \si{\kilo\watt} helium}
    \end{subfigure}
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=0.75\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/exp_total_Y2.pdf}
...
\begin{figure}[h!]
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=0.75\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/piecewise_A3.pdf}
       \caption{Solid temperature}
       \label{fig:plenuma}
    \end{subfigure}
        \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[height=0.75\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/A3_streamlines.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/histogram_abs_error.pdf}
...
\begin{figure}[h!]
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[width=1.0\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/error_radial.pdf}
       \caption{Error vs. distance from radial wall}
       \label{fig:error_locationa}
    \end{subfigure}
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[width=1.0\linewidth]{../../pronghorn/doc/papers/SANA-Revisited/figures/error_axial.pdf}

...
\begin{figure}[!h]
\centering
\includegraphics[width=0.45\linewidth]{../../pronghorn/doc/manual/figures/fe_mesh.png}
...
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{../../pronghorn/doc/figures/convective_process.pdf}
  \caption{Convective phenomenon}
\end{subfigure}
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{../../pronghorn/doc/figures/diffusive_process.pdf}
